...
int main(int argc, char const *argv[])
{
    ...
    while (true) // Bucle while principal
    {
        ...
        while (true) // Bucle while para mover el carro
        {
            ...
            can.DrawPointLine(45 + frame, 22, 45 + frame, 27); // línea trasera
            can.DrawPointLine(45 + frame, 27, 52 + frame, 27); // líneas frontales
            can.DrawPointLine(52 + frame, 35, 52 + frame, 28); // líneas frontales
